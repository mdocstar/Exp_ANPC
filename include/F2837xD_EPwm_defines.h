...
#define LoadPWM    {EPwm1Regs.CMPA.bit.CMPA = Svgen_Mul.Da1 * EPWM_TBPRD;\
                    EPwm2Regs.CMPA.bit.CMPA = Svgen_Mul.Da2 * EPWM_TBPRD;\
                    EPwm4Regs.CMPA.bit.CMPA = Svgen_Mul.Db1 * EPWM_TBPRD;\
                    EPwm5Regs.CMPA.bit.CMPA = Svgen_Mul.Db2 * EPWM_TBPRD;\
